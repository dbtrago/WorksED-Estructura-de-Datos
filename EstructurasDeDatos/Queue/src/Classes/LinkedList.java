...
public class LinkedList<T> implements List<T>
{
    ...
    public boolean add(T object)//1
    {
        ...
        {
            return false; //retornar el valor booleano que indica si hubo una insercion o no
        }
    }
    /***
     ...
     * @return boolean true
     */
    public boolean addFirst(Object object)//6
    {
    	try
    	{
    		LinkedListNode newNode = new LinkedListNode(object);
	...
	public Object containsObject(T object)//12
	{
		LinkedListNode currentNode = head;
		while (currentNode != null)
		{
	...
	public Object containsNode(Double object)//12
	{
		LinkedListNode currentNode = head;
		long tamaño = 0;
		while (currentNode != null)
